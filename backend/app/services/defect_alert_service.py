...
async def _create_alert(
    ...
    """Create a notification if no duplicate unread exists. Returns None if deduplicated."""
...
async def scan_approaching_deadlines(
    ...
    Args:
        ...
        threshold_days: Number of days before deadline to trigger alert (default 14).
